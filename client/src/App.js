...
import { faStroopwafel, faSearch, faSlidersH, faPizzaSlice, faCookie, faCoffee, faCandyCane, faLeaf } from '@fortawesome/free-solid-svg-icons'
library.add(faStroopwafel, faSearch, faSlidersH, faPizzaSlice, faCookie, faCoffee, faCandyCane, faLeaf);
